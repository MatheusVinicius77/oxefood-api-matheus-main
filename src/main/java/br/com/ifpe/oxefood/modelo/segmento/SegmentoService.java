...
public class SegmentoService {
    ...
    public void update(Long id, Segmento segmentoAlterado) {
        ...
        segmento.setDescricao(segmentoAlterado.getDescricao()); // c18
    ...
    public void delete(Long id) {
        ...
        Segmento segmento = repository.findById(id).get();
        segmento.setHabilitado(Boolean.FALSE);// exclusão lógica - move o objeto para false tirando-o da consulta

        repository.save(segmento);// repository.delete faria a remoção fisica
    }
}
